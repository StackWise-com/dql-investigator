...
const SECTIONS: Section[] = [
  {
    ...
    blocks: [
      {
        type: "paragraph",
        text: "DQL (Dynatrace Query Language) is a pipeline-oriented language built for processing arbitrary event data. Unlike SQL, DQL requires no up-front schema description — you shape the data on the fly as it flows through commands.",
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "A DQL query is a chain of commands separated by the pipe character (|). Each command transforms the dataset and passes it to the next stage:",
      },
      {
        type: "code",
...
| limit 100`,
      ...
      },
      {
        ...
        rows: [
          ["Filter as early as possible", "Reduces the dataset size for downstream commands, improving performance."],
  ...
  },
  {
    ...
    blocks: [
      {
        type: "paragraph",
        text: "Commands are the building blocks of every DQL pipeline. Each command receives the output of the previous command and produces a new dataset.",
      },
      {
        type: "heading",
